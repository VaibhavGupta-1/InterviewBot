...
android {
    namespace = "com.example.interviewbot"
    compileSdk = 34 // Or your SDK version

    defaultConfig {
        applicationId = "com.example.interviewbot"
        ...
        // Use the value we loaded from the properties file
    ...
    buildFeatures {
        compose = true
        buildConfig = true // This line is correct
    }
    composeOptions {
